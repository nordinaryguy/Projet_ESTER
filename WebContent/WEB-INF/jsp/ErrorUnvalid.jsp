  	...
  	<div class="row">
			  <div class="text-center mb-4">
		      	  ...
		      	  <div class="container form-reset">
		      	  		...
		      	  		<div class="row">
		      	  			<div class="col-md-4 pl-0"><img class="mb-4" src="/Projet_ESTER/IMG/error.svg.png" alt="" width="90" height="90"></div>
		      	  		</div>
		      	  		<div class="row">
							<h5 style="color:red;text-align: center;">Le lien pour réinitialiser le mot de passe a expiré ou n'a jamais existé</h5>
				   		</div>
		      	  </div>
