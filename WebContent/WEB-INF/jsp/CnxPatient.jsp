  	...
  	<div class="row">
	    ...
	    <form class="form-signin" method="post">
		      <div class="text-center mb-4">
			       ...
			       <div class="row">        
			      		 <div class="col-md-12 col-centered "><h5 class="h5 mb-3 font-weight-normal">Veuillez saisir votre identifiant</h5></div>
			       </div>
			
			 	   <div class="form-label-group">
				        <input type="text" id="CodeInscription" name="codePatient" class="form-control" value="${empty codePatient ? '' : codePatient}" required>
				        <label for="CodeInscription" >Code d'inscription</label>
			       </div>
			      
			                  
			       <div class="row">  
					 	<div class="col-md-12 col-centered "><strong style="color:red"> ${empty message ? '' : message } </strong></div>
				   </div>
