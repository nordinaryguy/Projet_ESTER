...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark shadowbottom">
	 <div class="row">
 <div class="col-md-1" style="text-align:center;"><a href="<c:url value="/utilisateur"/>"><img src="<c:url value="/img/retour.png"/>" alt="retour"  width="65"></a></div>	 	 <div class="col-md-5" style="text-align:center;"><img src="<c:url value="/img/irset.png"/>" alt="Logo-ister" width="155"></div>
              ...
              <fieldset>
                <div class="tab-content">
                  <div class="tab-pane active" id="1">
                    ...
                    <div class="form-group component" rel="popover" title="Multiple Checkboxes" 
                      data-content="
                      <form class='form'>
                        <div class='form-group col-md-12'>
                          <label class='control-label'>texte</label> <input class='form-control' type='text' name='label' id='label'>
                    ...
                    <div class="form-group component" rel="popover" title="Multiple Radios" 
                      data-content="
                      <form class='form'>
                        <div class='form-group col-md-12'>
                          <label class='control-label'>Texte</label> <input class='form-control' type='text' name='label' id='label'>
                    ...
                    <div class="form-group component" rel="popover" title="File Upload" 
                      data-content="
                      <form class='form'>
                        <div class='form-group col-md-12'>
                          <label class='control-label'>texte</label> <input class='form-control' type='text' name='label' id='label'>
                    ...
                    <div class="form-group component" rel="popover" title="slideBare" 
                      data-content= '<form class="form">
                        <div class="form-group col-md-12">
